...
const viewarchieves = async (item) => {
  ...
  return (
    <div>
      {!showcards && items.map((item, index) => (
        <div key={index} className='cardwrapper'>
          <div className="cardcontents">
            ...
            <div className='links'>
              ...
              <div className='link'>Relay1: <pre> { location.state.relay1 }</pre> </div>
              <div className='link'>Relay2: <pre> { location.state.relay2 }</pre> </div>
              <div className='link'>Relay3: <pre> { location.state.relay3 }</pre> </div>
            </div>
